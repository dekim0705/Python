# 고객의 이름 입력 받기
# 행사 제목 입력 받기
# 행사 날짜 입력 받기 : 날짜를 입력 받아 몇월인지 확인하고 그에 맞는 행사 문구 가져와서 출력
# 행사 시간 입력 받기

name = input("고객님의 이름을 입력해 주세요 : ")
event = input("행사 제목을 입력해 주세요 : ")
date = input("행사 날짜를 입력해 주세요 : ")
time = input("행사 시간을 입력해 주세요 : ")
...
print(f"""{name}님
{greeting}
아래의 일정으로 {event}를 진행하고자 하오니 오셔서
자리를 빛내 주시기 바랍니다. 
{"="*5} 행사 안내 {"="*5}
행사안내 : {event}
일시 : {date[:4]}년 {date[4:6]}월 {date[6:8]}일
시간 : {time}시
""")
